...
public class NumberTranslatorUtil {

  private static String cantidadConLetra(String s) {
    StringBuilder result = new StringBuilder();
    BigDecimal totalBigDecimal = new BigDecimal(s).setScale(2, RoundingMode.HALF_DOWN);
  ...
  /**
   * Translate a big decimal number to String value name
   *
   * @param number value to transform to string
   * @param currency Only supports MXN and USD
   * @return String value of the number
   */
  public static String getStringNumber(BigDecimal number, String currency) throws PptUtilException {
    String exchange;
    if (number == null) throw new PptUtilException("Number is mandatory");
    if (currency == null || currency.isBlank()) throw new PptUtilException("currency is mandatory");
